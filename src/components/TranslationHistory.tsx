...
import { History, ArrowRight, Copy, Check } from "lucide-react";
import { TranslationHistoryItem, getTranslationHistory } from "@/lib/translationApi";
...
const TranslationHistory = ({ onSelectTranslation }: TranslationHistoryProps) => {
  ...
  const fetchHistory = async () => {
    try {
      setLoading(true);
      const historyData = await getTranslationHistory(getToken);
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-center py-8 text-muted-foreground">
            ...
            <p className="text-sm">Your translations will appear here after you translate text</p>
          </div>
        </CardContent>
      </Card>
    );
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Your last {history.length} translations</CardDescription>
      </CardHeader>
      <CardContent>
