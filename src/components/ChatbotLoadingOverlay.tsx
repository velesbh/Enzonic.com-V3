...
interface ChatbotLoadingOverlayProps {
  isLoading: boolean;
}

const ChatbotLoadingOverlay = ({ isLoading }: ChatbotLoadingOverlayProps) => {
  ...
  return (
    ...
    >
      {/* Animated background lines - AI circuit-like paths */}
      ...
      <div className="relative z-10 flex flex-col items-center gap-6 animate-float">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-sm text-muted-foreground animate-fade-in-out">Crafting the perfect response</p>
        </div>
...
export default ChatbotLoadingOverlay;
