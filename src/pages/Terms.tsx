        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-slate dark:prose-invert">
            ...
            <section className="space-y-6">
              ...
              <div>
                <h2 className="text-2xl font-semibold mb-4">11. User-Generated Content Liability Limitation</h2>
                <p className="text-muted-foreground mb-4">
                  <strong>USER-GENERATED CONTENT DISCLAIMER:</strong> Enzonic LLC provides platforms and services that may allow users to upload, share, or generate content, including but not limited to music files, text, images, AI-generated content, and other materials. You acknowledge and agree that:
                </p>
                <ul className="list-disc pl-6 space-y-2 text-muted-foreground mb-4">
                  <li><strong>No Responsibility for User Content:</strong> Enzonic LLC is not responsible for any user-generated content, including but not limited to music, text, images, videos, or any other materials uploaded, shared, or generated by users</li>
                  <li><strong>No Endorsement or Verification:</strong> The presence of user-generated content on our platforms does not constitute endorsement, approval, or verification by Enzonic LLC</li>
                  <li><strong>Content Accuracy and Legality:</strong> We do not verify the accuracy, legality, or appropriateness of user-generated content and assume no liability for any inaccuracies, errors, or illegal content</li>
                  <li><strong>Third-Party Claims:</strong> Users are solely responsible for ensuring their content does not infringe on third-party rights, including copyright, trademark, privacy, or other intellectual property rights</li>
                  <li><strong>Indemnification:</strong> You agree to indemnify and hold Enzonic LLC harmless from any claims, damages, losses, or expenses arising from your user-generated content or any third-party claims related thereto</li>
                  <li><strong>Content Removal:</strong> While we may remove content that violates these terms, we have no obligation to monitor, review, or remove user-generated content</li>
                  <li><strong>AI-Generated Content:</strong> Content generated by our AI services is considered user-generated content and is subject to the same liability limitations</li>
                </ul>
                <p className="text-muted-foreground">
                  You use our services and interact with user-generated content at your own risk. Enzonic LLC expressly disclaims all liability for any harm, damages, or losses resulting from user-generated content.
                </p>
              </div>

              <div>
                <h2 className="text-2xl font-semibold mb-4">12. Modifications and Termination</h2>
                <p className="text-muted-foreground">
