...
const SearchLoadingOverlay = ({ isLoading }: SearchLoadingOverlayProps) => {
  ...
  return (
    ...
    >
      {/* Animated background lines - drawing circuit-like paths */}
      ...
      <div className="relative z-10 flex flex-col items-center gap-6 animate-float">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-sm text-muted-foreground animate-fade-in-out">Finding the best results for you</p>
        </div>
